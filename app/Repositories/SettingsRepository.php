...
class SettingsRepository
{
    ...
    public function updateSettings($input)
    {
        ...
        if (isset($input['favicon_logo']) && ! empty($input['favicon_logo'])) {
            $this->deleteFavicon();
            $fileName = ImageTrait::makeImage($input['favicon_logo'], 'favicon', []);
            $input['favicon_url'] = Storage::url('favicon/'.$fileName);
        }
    ...
    public function uploadLogo($file): string
    {
        ...
        if (in_array($extension, ['jpg', 'png', 'jpeg'])) {
            ...
            throw new UnprocessableEntityHttpException(__('messages.new_keys.image_upload_valid'));
        }
    }
    ...
    public function uploadFavicon($file)
    {
        ...
        if (in_array($extension, ['jpg', 'png', 'jpeg'])) {
            ...
            Storage::put($fileName, $imageThumb->__toString());
    ...
    public function uploadNotificationSound($file)
    {
        ...
        if (in_array($extension, ['mp4', 'mp3', 'ogg', 'wav', 'aac', 'alac', 'zip', 'rar'])) {
            ...
            throw new UnprocessableEntityHttpException(__('messages.new_keys.audio_upload_valid'));
        }
    }

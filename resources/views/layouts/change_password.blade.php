        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-sm-12 position-relative">
                    ...
                    {!! Form::password('password', ['class' => 'form-control login-group__input', 'required','placeholder'=>__('messages.new_password'),'data-toggle'=>'password']) !!}
                ...
                <div class="form-group col-sm-12 mb-4 position-relative">
                    {!! Form::label('password_confirmation', __('messages.confirm_password').':', ['class' => 'login-group__sub-title']) !!}<span
                            class="red">*</span>
                    {!! Form::password('password_confirmation', ['class' => 'form-control login-group__input', 'required','placeholder'=> __('messages.confirm_password'),'data-toggle'=>'password']) !!}
                    <span class="position-absolute d-flex align-items-center top-0 bottom-0 end-0 me-4 input-icon input-password-hide cursor-pointer text-gray-600">
                        <i class="fa fa-eye-slash"></i>
                    </span>
                </div>
